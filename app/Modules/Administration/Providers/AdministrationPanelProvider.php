...
class AdministrationPanelProvider extends PanelProvider
{
    ...
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->default()
            ->discoverClusters(in: app_path('Modules/Administration/Clusters'), for: 'App\Modules\Administration\Clusters')
            ->discoverLivewireComponents(in: app_path('Modules/Administration/Livewire/Components'), for: 'App\Modules\Administration\Livewire\Components')
            ->discoverPages(in: app_path('Modules/Administration/Pages'), for: 'App\Modules\Administration\Pages')
            ->discoverResources(in: app_path('Modules/Administration/Resources'), for: 'App\Modules\Administration\Resources')
            ->discoverWidgets(in: app_path('Modules/Administration/Widgets'), for: 'App\Modules\Administration\Widgets')
            ->favicon('favico.ico')
            ->login()
